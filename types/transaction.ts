...
export interface Transaction {
  ...
  /** Binpay purchase/cashout reference returned by the API after send-to-binpay. */
  binpay_order_id?: string | null;
  ...
  /** PayAPI provider status after send-to-payapi / webhook updates. */
  payapi_status?: string | number | null;
  /** PayAPI order id returned after send-to-payapi. */
  payapi_order_id?: string | null;
