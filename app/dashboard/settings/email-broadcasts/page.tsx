              ...
              <tbody>
                {filtered.map((broadcast) => {
                  ...
                  return (
                    <tr
                      key={broadcast.id}
                      onClick={() => openCompose(seed)}
                      title={isDraft ? 'Edit this draft' : 'Reuse this campaign'}
                    ...
                    >
                      <td className="max-w-[320px] py-3 pl-4 pr-3">
                        ...
                        {broadcast.last_error ? (
                          <p className="mt-0.5 truncate text-[11px] text-red-500" title={broadcast.last_error}>
                            {broadcast.last_error}
                          </p>
                        ) : null}
                      </td>
