...
import { RechargeBonusForm, ErrorState, EmptyState } from '@/components/features';
import { Skeleton } from '@/components/ui';
import type { RechargeBonus, UpdateBonusRequest } from '@/types';
import { formatCurrency } from '@/lib/utils/formatters';

export function RechargeBonusPageContent() {
  const { 
    rechargeBonuses,
    isLoading,
    error,
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Bonuses Table */}
      <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
        {!rechargeBonuses || rechargeBonuses.results.length === 0 ? (
          <div className="py-12">
            <EmptyState 
