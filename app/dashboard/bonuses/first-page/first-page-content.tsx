...
import { FirstPurchaseBonusForm, ErrorState, EmptyState } from '@/components/features';
import { Skeleton } from '@/components/ui';
import type { FirstPurchaseBonus, UpdateBonusRequest } from '@/types';
import { formatCurrency } from '@/lib/utils/formatters';

export function FirstPurchaseBonusPageContent() {
  const { 
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Bonuses Table */}
      <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
        {!firstPurchaseBonuses || firstPurchaseBonuses.results.length === 0 ? (
          <div className="py-12">
            <EmptyState 
