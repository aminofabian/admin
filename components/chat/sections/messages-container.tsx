...
import { formatMessageDate, isAutoMessage, isPurchaseNotification, isPrizeWheelMessage, isKycVerificationMessage } from '../utils/message-helpers';
      ...
      {Object.entries(groupedMessages).map(([date, dateMessages]) => (
        <div key={date} className="space-y-3">
          ...
          {dateMessages.map((message, idx) => {
            ...
            const isConsecutive = !isSystemMessage && prevMessage && !isAutoMessage(prevMessage) && !isPurchaseNotification(prevMessage) && !isPrizeWheelMessage(prevMessage) && !isKycVerificationMessage(prevMessage) && prevMessage.sender === message.sender;
