                                                ...
                                                <CardContent className="p-0">
                                                    <div className="border-t border-border/40 bg-gradient-to-b from-muted/30 to-muted/10 dark:from-muted/30 dark:to-muted/10 dark:border-border/50">
                                                        {method.subcategories.map((sub) => (
                                                            <div
                                                                key={sub.id}
                                                                className="group relative flex flex-col md:flex-row md:items-center justify-between gap-4 pl-8 md:pl-10 pr-4 md:pr-6 py-4 border-b border-border/30 dark:border-border/40 last:border-b-0 bg-gradient-to-br from-card via-card to-muted/20 dark:from-card dark:via-card/95 dark:to-muted/40 hover:bg-white/60 dark:hover:bg-white/[0.06] transition-all duration-200 before:absolute before:left-0 before:top-0 before:bottom-0 before:w-[3px] before:bg-gradient-to-b before:from-primary/40 before:to-primary/10 dark:before:from-primary/50 dark:before:to-primary/20 before:opacity-50 hover:before:opacity-100 before:transition-opacity"
                                                            >
                                                                <div className="flex items-center gap-4 min-w-0">
