    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
          ...
          <div className="flex items-center gap-2 py-2 sm:py-2.5 md:py-3 lg:py-4">
            ...
            <div className="flex items-center gap-2 sm:gap-2.5 md:gap-3 flex-1 min-w-0">
              <button
                ...
                className="flex h-8 w-8 sm:h-9 sm:w-9 md:h-10 md:w-10 lg:h-12 lg:w-12 shrink-0 items-center justify-center bg-gray-800 text-white font-bold dark:bg-gray-700 text-xs sm:text-sm md:text-base hover:bg-gray-600 dark:hover:bg-gray-500 transition-colors cursor-pointer active:scale-95"
      ...
      <div className="w-full px-3 sm:px-4 md:px-6 lg:px-8 py-3 sm:py-4 md:py-6 pb-safe">
        <PlayerAccountOverview
          ...
          showAgent={false}
          canEditCashoutLimit={canEditPlayerCashoutLimit(USER_ROLES.SUPERADMIN)}
            ...
            <section className="border border-gray-200 bg-white p-3 sm:p-4 md:p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
              <div className="mb-4 sm:mb-5 flex items-center justify-between gap-3">
                ...
                <Button
                  ...
                  className="flex shrink-0 items-center gap-1.5 px-3 py-1.5 text-xs font-semibold shadow-sm transition-all hover:shadow-md active:scale-95"
                >
              ...
              {isLoadingGames ? (
                <div className="space-y-3">
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="h-24 animate-pulse bg-gray-200 dark:bg-gray-700" />
                  ))}
                </div>
              ) : games.length === 0 ? (
                <div className="py-12 text-center">
                  <div className="mx-auto flex h-16 w-16 items-center justify-center bg-gray-100 dark:bg-gray-800">
                    ...
                    >
                      <div className="mb-3 flex items-start justify-between gap-3">
                        ...
                        <div className="flex shrink-0 items-center gap-1.5">
                          <div className={`h-2 w-2 ${game.status === 'active' ? 'bg-green-500' : 'bg-red-500'}`} />
                          <Badge
                      ...
                      <div className="flex items-center justify-between gap-3">
                        <Button
                          ...
                          className="flex items-center gap-1.5 bg-gradient-to-r from-blue-600 to-indigo-600 px-3 py-1.5 text-xs font-semibold text-white shadow-sm transition-all hover:from-blue-700 hover:to-indigo-700 hover:shadow-md active:scale-95"
                        >
                          <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
