...
import type { CheckStoreBalanceResponse } from '@/types';

interface StoreBalanceModalProps {
  isOpen: boolean;
  onClose: () => void;
  gameTitle: string;
  balanceData: CheckStoreBalanceResponse | null;
  isLoading: boolean;
  error: string | null;
}

export const StoreBalanceModal = ({
  isOpen,
  onClose,
  gameTitle,
  balanceData,
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Store Balance Check">
          ...
          <div className="space-y-4">
            <div className="bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-800/50 rounded-lg p-6 text-center">
              ...
              <p className="text-4xl font-bold text-green-700 dark:text-green-300">
                {formatCurrency(balanceData.total_balance || 0)}
              </p>
            </div>
