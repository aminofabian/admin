...
function parseDob(value: string): { month: string; day: string; year: string } {
...
function buildDob(month: string, day: string, year: string): string {
...
export function DateOfBirthSelect({
  ...
  const handleMonthSelect = useCallback(
    (monthIndex: number) => {
      ...
      const full = buildDob(m, day.padStart(2, '0'), year);
  ...
  const handleDaySelect = useCallback(
    (d: string) => {
      ...
      const full = buildDob(month.padStart(2, '0'), d.padStart(2, '0'), year);
      if (full) onChange(full);
      setOpenPicker(null);
    },
    [month, year, onChange],
  ...
  const handleYearSelect = useCallback(
    (y: string) => {
      ...
      const full = buildDob(month.padStart(2, '0'), day.padStart(2, '0'), y);
      if (full) onChange(full);
      setOpenPicker(null);
    },
    [month, day, onChange],
