...
interface FirstPurchaseBonusFormProps {
  ...
  onCancel: () => void;
  isLoading?: boolean;
  initialData?: FirstPurchaseBonus;
}

export function FirstPurchaseBonusForm({ 
  onSubmit, 
  onCancel, 
  isLoading = false,
  initialData,
}: FirstPurchaseBonusFormProps) {
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-blue-700 dark:text-blue-400">
              You can only update the bonus percentage and active status. Bonus name cannot be changed.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">Bonus name cannot be changed</p>
        </div>
