...
import { getPurchaseBonusPaymentLabel } from '@/lib/utils/formatters';
import { sortPurchaseBonusesForDisplay } from '@/lib/utils/purchase-bonuses-organize';
...
export function BonusWidget() {
  ...
  const sortedPurchaseBonuses = useMemo(
    () => sortPurchaseBonusesForDisplay(purchaseBonusesList),
    [purchaseBonusesList],
  );
                  ...
                  {category.id === 'topup' && (
                    <div className="space-y-2.5">
                      ...
                      {purchaseBonusesList.length === 0 ? (
                        ...
                        sortedPurchaseBonuses.map((bonus) => (
                          <div
                            key={bonus.id}
                            className="flex justify-between items-center p-2 bg-secondary/50 mb-2 last:mb-0"
                          >
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-sm text-foreground font-medium">
                                {getPurchaseBonusPaymentLabel(bonus)}
                              </span>
                            </div>
