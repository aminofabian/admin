...
/**
 * Manager Bonuses Section - Read-only
 * Shows bonuses but does not allow editing
 */
export function ManagerBonusesSection() {
  const {
    purchaseBonuses,
    rechargeBonuses,
    transferBonuses,
  ...
  // Manager users don't have permission to access affiliate defaults
  ...
  useEffect(() => {
    const fetchBonusesForStaff = async () => {
      ...
      const results = await Promise.allSettled([
        ...
        fetchSignupBonuses(),
        fetchFirstPurchaseBonuses(),
        // Skip fetchAffiliateDefaults() - manager doesn't have permission
      ]);
