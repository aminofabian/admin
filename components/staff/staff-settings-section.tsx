...
const settingsCategories = [
  {
    ...
    description: 'View bonus configurations (read-only)',
    icon: (
  ...
  },
  {
    ...
    description: 'View affiliate commission settings (read-only)',
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    id: 'games',
    title: 'Game Settings',
    description: 'View game status and dashboard URLs (read-only)',
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
 ...
 * Shows settings categories but does not allow editing
 */
