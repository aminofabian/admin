...
export function StaffFirstPurchaseBonusPage() {
  const { 
  ...
  const firstPurchaseBonusesList = firstPurchaseBonuses?.results || [];
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Bonuses Table */}
      <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
        {!firstPurchaseBonuses || firstPurchaseBonusesList.length === 0 ? (
          <div className="py-12">
            <EmptyState 
          ...
          <div className="overflow-x-auto">
            <Table>
              ...
              <TableBody>
                {firstPurchaseBonusesList.map((bonus) => (
